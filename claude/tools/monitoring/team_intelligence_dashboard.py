...
class TeamIntelligenceDashboard:
    ...
    def setup_health_endpoints(self):
        ...
        def health_check():
            ...
            try:
                ...
                return jsonify({
                    "status": "healthy" if team_count > 0 else "degraded",
                    "uptime": 0,
                    "version": "1.0.0",
                    "service": "team_intelligence_dashboard",
    ...
    def setup_layout(self):
        ...
        self.app.layout = dbc.Container([
            ...
            dbc.Row([
                dbc.Col([
                    html.H1("🎯 Team Intelligence Dashboard", className="text-primary mb-3"),
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H4("👥 Team Size", className="card-title"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H4("📈 Avg Performance", className="card-title"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H4("🎓 Senior Members", className="card-title"),
                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            html.H4("☁️ Azure Experts", className="card-title"),
            ...
            # Main Content Tabs
            dbc.Tabs([
                dbc.Tab(label="👥 Team Composition", tab_id="composition"),
                dbc.Tab(label="📊 Skills Matrix", tab_id="skills"),
                dbc.Tab(label="📈 Performance Analytics", tab_id="performance"),
                dbc.Tab(label="🎯 Strategic Planning", tab_id="strategic"),
                dbc.Tab(label="📋 Team Directory", tab_id="directory")
    ...
    def create_composition_tab(self):
        ...
        return dbc.Row([
            ...
            dbc.Col([
                html.H4("🎯 Team Insights", className="mb-3"),
                dbc.Alert([
    ...
    def create_strategic_tab(self):
        ...
        return dbc.Row([
            dbc.Col([
                html.H4("🎯 Strategic Priorities", className="mb-3"),
            ...
            dbc.Col([
                html.H4("📊 Development Pipeline", className="mb-3"),
                
                html.H6("Ready Now (0-6 months):"),
                html.Ul([
                    html.Li("Alex Olver → Technical Lead role"),
                    html.Li("2-3 mid-level engineers → Senior positions")
                ]),
                
                html.H6("Medium Term (6-18 months):"),
                html.Ul([
                    html.Li("Senior engineers → Principal/Architect roles"),
                    html.Li("Graduate/Junior → Mid-level progression"),
    ...
    def create_directory_tab(self):
        ...
        return dbc.Row([
            dbc.Col([
                html.H4("👥 Team Directory", className="mb-3"),
    ...
    def run(self, debug=False, host='127.0.0.1', port=8051):
        """Run the dashboard"""
        print(f"\n🚀 Team Intelligence Dashboard starting...")
        print(f"📊 Loaded {len(self.team_data)} team members")
        print(f"🎯 URL: http://{host}:{port}")
        print(f"🔧 Integration ready for AI Dashboard as 9th tab")
...
def main():
    ...
    # Unified port management - always use environment variable (registry-assigned)
    port = int(os.environ.get('DASHBOARD_PORT', os.environ.get('PORT', '8050')))
